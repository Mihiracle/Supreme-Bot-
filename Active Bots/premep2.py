...
#ui = userInput(); 
keywords = "nylon windbreaker".split() #ui[0].lower().split()
size = "medium"#ui[1]
category = "jackets"#ui[2]
color = "burgundy"#ui[3]
...
form[formName[0].controls[15].name] = cNumberReal #<-- test number for testing cNumberReal is real number 
